...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $v2 = Vozilo::create([
            ...
            'cenaPoDanu' => 45.00,
            'status' => 'DOSTUPNO',
            'image_url' => 'https://image.stern.de/34392470/t/8F/v3/w1440/r1.7778/-/vw-golf-8-gti--mj-2024--1.jpg',
            'godiste' => 2021,
            'gorivo' => 'Benzin',
            'menjac' => 'Manuelni',
            'sedista' => 5
        ...
        $v4 = Vozilo::create([
            ...
            'cenaPoDanu' => 110.00,
            'status' => 'DOSTUPNO',
            'image_url' => 'https://assets.adac.de/image/upload/v1/Autodatenbank/Fahrzeugbilder/im02704-1-audi-a6.jpg',
            'godiste' => 2022,
            'gorivo' => 'Dizel',
            'menjac' => 'Automatski',
            'sedista' => 5
        ...
        $v5 = Vozilo::create([
            ...
            'cenaPoDanu' => 30.00,
            'status' => 'DOSTUPNO',
            'image_url' => 'https://www.topgear.com/sites/default/files/cars-car/image/2021/05/fiat_500_la-prima_020.jpg?w=1280&h=720',
            'godiste' => 2020,
            'gorivo' => 'Električno',
            'menjac' => 'Automatski',
            'sedista' => 4
